    ...
    */    
    private function frenchLangWord(): array
    {
        return [
            ...
            'apres', 'avant', 'avec', 'chez', 'contre', 'dans', 'depuis', 'derriere', 'plusie','jour',
            'devant', 'entre', 'hors', 'cher', 'jusque', 'par', 'parmi', 'pendant', 'pour', 'sans', 'sauf', 
            'selon', 'sous', 'vers', 'via', 'et', 'ou', 'mais', 'car', 'donc', 'or', 'ni', 'malgre', 'grace', 
            'mechanc','mechamm', 'vis', 'pourquoi', 'qui', 'quel', 'quelle', 'quels', 'quelles', 'lequel', 'dir',
            'laquelle', 'communaute', 'moins', 'aussi', 'autant', 'tres', 'bien', 'mal', 'peu', 'beaucoup','heure','date','minute',
            'trop', 'assez', 'vraim', 'absolum', 'apparemm', 'bientot', 'bref', 'brusquem', 'certainem', 'cadre', 'vue',
            'constam', 'abord', 'ailleurs', 'habitude', 'deja', 'demain', 'emblee', 'prime', 'mise', 'donnees', 'date', 'requete', 'satisfai',
    ...
    */
    private function englishLangWord(): array
    {
        return [
            ...
            'outside', 'beneath', 'beyond', 'within', 'without', 'once', 'twice', 'thrice', 'often', 'seldom', 'rarely', 'never', 'always','month','year',
            'sometimes', 'everywhere', 'nowhere', 'somewhere', 'anywhere', 'there', 'here', 'when', 'where', 'why', 'how', 'what', 'whose', 'since','breath',
            'so', 'but', 'or', 'if', 'unless', 'while', 'until', 'whether', 'because', 'though', 'although', 'yet', 'still', 'even', 'just', 'only',
            'both', 'either', 'neither', 'also', 'too', 'indeed', 'nevertheless', 'furthermore', 'meanwhile', 'otherwise', 'therefore', 'thus','know',
